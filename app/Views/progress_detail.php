          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select id="project_progress" name="project_progress" class="form-control custom-select" required disabled>
              ...
              <div class="form-group">
                ...
                <select id="status" name="status" class="form-control custom-select" required disabled>
